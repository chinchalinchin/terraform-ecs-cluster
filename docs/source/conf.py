...
html_theme_options = {
    ...
    'base_url': 'https://pages.github.boozallencsn.com/AutomationLibrary/terraform-module-template/',
    ...
    'repo_url': 'https://github.boozallencsn.com/AutomationLibrary/terraform-module-template',
